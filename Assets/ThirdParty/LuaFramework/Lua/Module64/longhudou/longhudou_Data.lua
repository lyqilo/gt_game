...
function longhudou_Data.gameOver(buff)
     ...
     for i=1,longhudou_CMD.D_ALL_COUNT do
         ...
         --error("______gameOver________"..img);
     end
     logYellow("游戏具体值")
     logYellow(str)
    ...
    --longhudou_Event.dispathEvent(longhudou_Event.xiangqi_over); 
...
function longhudou_Data.gameSence(buff)
    ...
    --error("____gameSence_____");
     self.curSelectChoum = buff:ReadUInt32();
     error("______curSelectChoum_____"..self.curSelectChoum);
