...
function longhudou_LianLine.setPer(args)
   ...
   self.allfreegoldcont:Find("zhezhao"):GetComponent("RectTransform").sizeDelta = Vector2.New((Screen.height / Screen.width) * 750 + 20, 750 + 20);
...
function longhudou_LianLine.goodLuckGoldRollIng(obj,args)
   longhudou_PushFun.CreatShowNum(self.goodLuckSp.transform:Find("numcont"),args);
end
...
function longhudou_LianLine.winCaiJinGoldrollIng(obj,args)
   longhudou_PushFun.CreatShowNum(self.wincaijingoldcont.transform:Find("numcont"),args);
end
...
function longhudou_LianLine.freeAllGoldRollIng(obj,args)
   longhudou_PushFun.CreatShowNum(self.allfreegoldcont.transform:Find("numcont"),args);
end
...
function longhudou_LianLine.freeAnima(args) 
   ...
   item.transform:Find("numcont"):GetComponent("TextMeshProUGUI").text=RETTEXT(longhudou_Data.byFreeCnt)
