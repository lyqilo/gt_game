...
self.resimg_config =
{
    [self.six]      = {normalimg=self.six_img,      animaimg="icon_Anim_7",         loop = 2,animatype = 1},
    [self.seven]    = {normalimg=self.seven_img,    animaimg="icon_Anim_8",         loop = 2,animatype = 1},
    [self.eight]    = {normalimg=self.eight_img,    animaimg="icon_Anim_9",         loop = 2,animatype = 1},
    [self.nine]     = {normalimg=self.nine_img,     animaimg="icon_Anim_10",        loop = 2,animatype = 1},
    [self.cattle]   = {normalimg=self.cattle_img,   animaimg="icon_Anim_longzhua",  loop = 2,animatype = 3},
    [self.chicken]  = {normalimg=self.chicken_img,  animaimg="icon_Anim_huzhua",    loop = 2,animatype = 3},
    [self.monkey]   = {normalimg=self.monkey_img,   animaimg="icon_Anim_longtou",   loop = 2,animatype = 3},
    [self.horse]    = {normalimg=self.horse_img,    animaimg="icon_Anim_hutou",     loop = 2,animatype = 3},
    [self.wild]     = {normalimg=self.wild_img,     animaimg="icon_Anim_wild",      loop = 2,animatype = 3},
    [self.tiger]    = {normalimg=self.tiger_img,    animaimg="icon_Anim_free",      loop = 2,animatype = 3},
    [self.maxwild1] = {normalimg=self.maxwild1_img, animaimg="anima_toum",          loop = 1,animatype = 2},
    [self.maxwild2] = {normalimg=self.maxwild2_img, animaimg="icon_Anim_changlong", loop = 1,animatype = 3},
    [self.maxwild3] = {normalimg=self.maxwild3_img, animaimg="anima_toum",          loop = 1,animatype = 2},
}
--运动的时间
