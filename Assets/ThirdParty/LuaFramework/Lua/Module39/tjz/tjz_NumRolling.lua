...
-- callcom 运动完成
-- callupdate 中间更新
function tjz_NumRolling:setdata(snum,enum,dtimer)
...
function tjz_NumRolling:getisrun()
  return self.isrun;
end

function tjz_NumRolling:setfun(callobj,callcom,callupdate)
   self.callobj = callobj;
   self.callcom = callcom;
   self.callupdate = callupdate;
end

function tjz_NumRolling:update()
