...
function _CFish:_bgRotate(_dt)
    ...
    self.runRotationTime = self.runRotationTime - _dt * (self.playSpeed or 1);
...
--    if self._fishType>FishType.FISH_KIND_17 and self._fishType< FishType.FISH_KIND_22 then
--        --鱼死亡的声音
...
--    elseif self._fishType>=FishType.FISH_KIND_22 and self._fishType<=FishType.FISH_KIND_24 then
--        --播放炸弹声音
