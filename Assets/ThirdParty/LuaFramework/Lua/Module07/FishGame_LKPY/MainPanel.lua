...
local function Include()
    ...
    --通用
    GamePacketName("Module07/FishGame_LKPY");
...
function MainPanel.Update()
    if G_GlobalGame.RunningPlatform == RuntimePlatform.WindowsPlayer
    or G_GlobalGame.RunningPlatform == RuntimePlatform.WindowsEditor
    or G_GlobalGame.RunningPlatform == RuntimePlatform.WindowsWebPlayer
    or G_GlobalGame.IsEditor then
...
function MainPanel:FixedUpdate()
    local _dt = UnityEngine.Time.fixedDeltaTime;
