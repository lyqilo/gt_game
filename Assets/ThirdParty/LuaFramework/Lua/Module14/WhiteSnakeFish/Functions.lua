...
function CFunctionsLibs.FUNC_GetEffectPrefabName(_type)
    ...
    if _type == GlobalGame.Enum_BombEffectType.PauseScreen then
        return CFunctionsLibs.FUNC_GetPrefabName(GlobalGame.Enum_PrefabType.Effect_PauseScreen);
    end
    return nil;
end
...
--��ѯ�Ƿ��������ӵ�
function CFunctionsLibs.FUNC_BulletIsEnergy(_type)
    local bulletConfig =_globalGameConfig.GameConfig.Bullet[_type];
    if bulletConfig  then
        return bulletConfig.isEnergy;
    end
    return false;
end
