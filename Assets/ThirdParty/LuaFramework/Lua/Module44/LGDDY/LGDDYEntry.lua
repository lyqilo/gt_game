...
function LGDDYEntry.ShowText(str,short)
...
function LGDDYEntry.OnClickAutoItemCall()
    ...
    if self.currentAutoCount > 1000 then
        self.autoText.text = "∞ times left";
    else
        self.autoText.text = tostring(self.currentAutoCount) .. "times left";
    end
...
function LGDDYEntry.FreeGame()
    ...
    self.freeText.text =  tostring(self.freeCount + 1) .. "times left";
    LGDDY_Network.StartGame();
end
