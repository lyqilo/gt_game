...
function _CSwitchSceneControl:Init(transform)
    ...
    self.bgWater.transform:SetParent(self.switchBg);
...
--                return x-30,self.bottomBorder.position.y-30,Screen.width+30,self.topBorder.position.y+30;
--            else
--                return -30,self.bottomBorder.position.y-30,x+30,self.topBorder.position.y+30;
--            end
--        else
...
--        if self._gamePlayersControl:IsRotation() then
--            return self.rightLimiteBorderTrans.position.x,self.topLimiteBorderTrans.position.y,self.leftLimiteBorderTrans.position.x,self.bottomLimiteBorderTrans.position.y;
--        else
--            return self.rightLimiteBorderTrans.position.x,self.bottomLimiteBorderTrans.position.y,self.leftLimiteBorderTrans.position.x,self.topLimiteBorderTrans.position.y;
--        end
        return self.leftLimiteBorderTrans.position.x,self.bottomLimiteBorderTrans.position.y,self.rightLimiteBorderTrans.position.x,self.topLimiteBorderTrans.position.y;
    end
end
...
--    if self._gamePlayersControl:IsRotation() then
--        return self.rightBorderTrans.position.x,self.topBorder.position.y,self.leftBorderTrans.position.x,self.bottomBorder.position.y;
--    else
