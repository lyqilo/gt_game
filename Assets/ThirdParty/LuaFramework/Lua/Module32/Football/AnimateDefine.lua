...
local __Enum_AnimateKind           = {
    InvalidValue            = _idCreator(0), --0 无效值
    SpriteFrameAnimate      = _idCreator(),  --1 sprite帧动画
    ImageFrameAnimate       = _idCreator(),  --2 Image帧动画
    LocalMoveAnimate        = _idCreator(),  --3 移动
    LocalScaleAnimate       = _idCreator(),  --4 移动
    FadeInAnimate           = _idCreator(),  --5 淡入
    FadeOutAnimate          = _idCreator(),  --6 淡出 最后消失
    DelayTime               = _idCreator(),  --7 空闲时间，什么都不做，可以理解为停留时间 
};
--动画类型定义
local __Enum_AnimateStyle          = {
    InvalidValue        = _idCreator(0), --0无效值
    Wheel               = _idCreator(),     --1 
    Net                 = _idCreator(),     --2
    FadeOut             = _idCreator(),  --3 淡出
    FadeIn              = _idCreator(),  --4 淡入
    LocalScale          = _idCreator(),  --5 缩放
    LocalMove           = _idCreator(),  --6 本地移动
    SpriteFrame         = _idCreator(),  --7 sprite帧动画
    ImageFrame          = _idCreator(),  --8 Image帧动画
    Monster_1_Move      = _idCreator(), --9
    Icon_0              = _idCreator(), --10
    Icon_1_Shose        = _idCreator(), --11
    Icon_2_Card         = _idCreator(),--12
    Icon_3_Flag         = _idCreator(),--13
    Icon_4_Whistle      = _idCreator(),--14
    Icon_5_Ball         = _idCreator(),--15
    Icon_6_Vanguard     = _idCreator(),--16
    Icon_7_GoalKeeper   = _idCreator(),--17
    Icon_8_Trainer      = _idCreator(),--18
    Icon_9_Cup          = _idCreator(),--19
    Icon_10_Court       = _idCreator(),--20
    Icon_11_Referee     = _idCreator(),--21
    Quick_Scroll        = _idCreator(), --22 快速转动
    ShanGuang           = _idCreator(), --23 闪光
    Star                = _idCreator(), --24 星星

    Keeper_CT           = _idCreator(),--25
    Keeper_CD           = _idCreator(),--26
    Keeper_LT           = _idCreator(),--27
    Keeper_LD           = _idCreator(),--28
    
    FootBaller_1        = _idCreator(), --29 足球手  
    FootBaller_2        = _idCreator(), --30 足球手 
    FootBaller_3        = _idCreator(), --31 足球手 
    FootBaller_4        = _idCreator(), --32 足球手 
    FootBaller_5        = _idCreator(), --33足球手   
};
    --动画类型定义
local __Enum_AnimateSetStyle          = {
    InvalidValue        = _idCreator(0), --0 无效值
    Monster_1_Move      = _idCreator(), --1
    FootBaller          = _idCreator(),-- 2
};
...
local AnimateModelConfig = {
    AnimaStyleInfo = {  --单步动画
        ...
        [AnimateStyle.Icon_1_Shose] = {
            animateType     = AnimateKind.ImageFrameAnimate,  --默认为 AnimateKind.ImageFrameAnimate 帧动画
            isRaycastTarget = false, --是否接受事件，默认不接受
            abfileName  = "game_fb_ui",
            format="iconAnimate/shoe_%05d",--帧名字格式化 
            customFrames = {},  --自定义帧队列 
            frameBeginIndex=0, --开始帧索引
            frameCount     =16,
            frameInterval  =1, --帧索引间隔
            --frameMax       =11,
            interval       =0.06, --动画时间间隔
            isCorrentSize  = true, --是否需要矫正大小
            restartInterval= 0.34,    --循环时, 最后一帧到第一帧的时间间隔,为空默认取值interval;
        },
        [AnimateStyle.Icon_2_Card]  = {
            animateType     = AnimateKind.ImageFrameAnimate,  --默认为 AnimateKind.ImageFrameAnimate 帧动画
            isRaycastTarget = false, --是否接受事件，默认不接受
            abfileName  = "game_fb_ui",
            format="iconAnimate/rycard_%05d",--帧名字格式化 
            customFrames = {},  --自定义帧队列 
            frameBeginIndex=0, --开始帧索引
            frameCount     =16,
            frameInterval  =1, --帧索引间隔
        ...
        [AnimateStyle.Icon_3_Flag]  = {
            animateType     = AnimateKind.ImageFrameAnimate,  --默认为 AnimateKind.ImageFrameAnimate 帧动画
            isRaycastTarget = false, --是否接受事件，默认不接受
            abfileName  = "game_fb_ui",
            format="iconAnimate/sideflag_%05d",--帧名字格式化 
            customFrames = {},  --自定义帧队列 
            frameBeginIndex=0, --开始帧索引
            frameCount     =16,
            frameInterval  =1, --帧索引间隔
        ...
        [AnimateStyle.Icon_4_Whistle]  = {
            animateType     = AnimateKind.ImageFrameAnimate,  --默认为 AnimateKind.ImageFrameAnimate 帧动画
            isRaycastTarget = false, --是否接受事件，默认不接受
            abfileName  = "game_fb_ui",
            format="iconAnimate/whistle_%05d",--帧名字格式化 
            customFrames = {},  --自定义帧队列 
            frameBeginIndex=0, --开始帧索引
            frameCount     =16,
            frameInterval  =1, --帧索引间隔
        ...
        [AnimateStyle.Icon_5_Ball]  = {
            animateType     = AnimateKind.ImageFrameAnimate,  --默认为 AnimateKind.ImageFrameAnimate 帧动画
            isRaycastTarget = false, --是否接受事件，默认不接受
            abfileName  = "game_fb_ui",
            format="iconAnimate/ball_%05d",--帧名字格式化 
            customFrames = {},  --自定义帧队列 
            frameBeginIndex=0, --开始帧索引
            frameCount     =16,
            frameInterval  =1, --帧索引间隔
        ...
        [AnimateStyle.Icon_6_Vanguard] = {
            animateType     = AnimateKind.ImageFrameAnimate,  --默认为 AnimateKind.ImageFrameAnimate 帧动画
            isRaycastTarget = false, --是否接受事件，默认不接受
            abfileName  = "game_fb_ui",
            format="iconAnimate/forward_%05d",--帧名字格式化 
            customFrames = {},  --自定义帧队列 
            frameBeginIndex=0, --开始帧索引
            frameCount     =20,
            frameInterval  =1, --帧索引间隔
            ...
            interval       =0.05, --动画时间间隔
            isCorrentSize  = true, --是否需要矫正大小
            restartInterval= 0.3,    --循环时, 最后一帧到第一帧的时间间隔,为空默认取值interval;
        },
        [AnimateStyle.Icon_7_GoalKeeper] = {
            animateType     = AnimateKind.ImageFrameAnimate,  --默认为 AnimateKind.ImageFrameAnimate 帧动画
            isRaycastTarget = false, --是否接受事件，默认不接受
            abfileName  = "game_fb_ui",
            format="iconAnimate/keeper_%05d",--帧名字格式化 
            customFrames = {},  --自定义帧队列 
            frameBeginIndex=0, --开始帧索引
            frameCount     =20,
            frameInterval  =1, --帧索引间隔
        ...
        [AnimateStyle.Icon_8_Trainer]= {
            animateType     = AnimateKind.ImageFrameAnimate,  --默认为 AnimateKind.ImageFrameAnimate 帧动画
            isRaycastTarget = false, --是否接受事件，默认不接受
            abfileName  = "game_fb_ui",
            format="iconAnimate/coach_%05d",--帧名字格式化 
            customFrames = {},  --自定义帧队列 
            frameBeginIndex=0, --开始帧索引
            frameCount     =20,
            frameInterval  =1, --帧索引间隔
        ...
        [AnimateStyle.Icon_11_Referee] = {
            animateType     = AnimateKind.ImageFrameAnimate,  --默认为 AnimateKind.ImageFrameAnimate 帧动画
            isRaycastTarget = false, --是否接受事件，默认不接受
            abfileName  = "game_fb_ui",
            format="iconAnimate/scatter_%05d",--帧名字格式化 
            customFrames = {},  --自定义帧队列 
            frameBeginIndex=0, --开始帧索引
            frameCount     =20,
            frameInterval  =1, --帧索引间隔
