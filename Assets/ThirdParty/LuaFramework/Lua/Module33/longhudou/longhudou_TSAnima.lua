...
function longhudou_TSAnima.gameInit(args)
   self.tischoum.transform:Find("showchoum").gameObject:GetComponent("Text").text = "bet:"..longhudou_Data.curSelectChoum;
end
...
function longhudou_TSAnima.showWinTs(opendata)
   ...
   self.tischoum.gameObject:SetActive(false);   
   self.showWinItem.transform:Find("num").gameObject:GetComponent("Text").text = opendata.byKey.."Combo";
