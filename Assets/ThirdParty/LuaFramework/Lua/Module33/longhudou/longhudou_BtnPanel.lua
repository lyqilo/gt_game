...
function longhudou_BtnPanel.setPer(args)
   ...
   self.addEvent();
    ...
    longhudou_PushFun.CreatShowNum(self.WinGoldNum,0,"win_gold_",false,58,2,310,-145);
...
function longhudou_BtnPanel.winGoldRollIng(obj,args)
    longhudou_PushFun.CreatShowNum(self.WinGoldNum,args,"win_gold_",false,58,2,310,-145);
end
...
function longhudou_BtnPanel.winGoldRollCom(obj,args)
   ...
   if self.showWinData.iscom==true then
       longhudou_PushFun.CreatShowNum(self.WinGoldNum,longhudou_Data.lineWinScore,"win_gold_",false,58,2,310,-145);
...
function longhudou_BtnPanel.showFreeTipHander(args)
     --longhudou_PushFun.CreatShowNum(self.freeTips.transform:Find("numcont"),longhudou_Data.byFreeCnt,"win_gold_",false,58,2,120,3);
    self.freeTips.transform:Find("numcont").gameObject:GetComponent("Image").sprite =  longhudou_Data.numres.transform:Find("freetis_"..(longhudou_Data.byFreeCnt/5)).gameObject:GetComponent("Image").sprite;
    self.freeTips.transform:Find("numcont").gameObject:GetComponent("Image"):SetNativeSize();
...
function longhudou_BtnPanel.caijinChang(args)
     ...
     if mindex > 0 then
        longhudou_PushFun.CreatShowNum(self.caijinNum,math.ceil(longhudou_Data.caijin*(mindex*0.2)),"caijin_",false,29,2,230,-66);
     end
end
...
function longhudou_BtnPanel.showChoumValue(args)   
   ...
   self.choumtxt.gameObject:GetComponent("Text").text = longhudou_Data.baseRate.." × bet:"..longhudou_Data.curSelectChoum;
   longhudou_PushFun.CreatShowNum(self.chouNum,longhudou_Data.curSelectChoum*longhudou_Data.baseRate,"choum_",false,18,2,210,-566);
   longhudou_PushFun.CreatShowNum(self.WinGoldNum,0,"win_gold_",false,58,2,310,-145);
   longhudou_Event.dispathEvent(longhudou_Event.xiongm_choum_chang);
   --longhudou_PushFun.CreatShowNum(self.allPushNum,longhudou_Data.curSelectChoum*longhudou_CMD.D_LINE_COUNT,"choum_",false,18,2,230,-384);
end
...
function longhudou_BtnPanel.freeNumChang(args)
  longhudou_PushFun.CreatShowNum(self.freeNumCont,longhudou_Data.byFreeCnt-1,"free_",false,39,2,226,-100);
end
...
function longhudou_BtnPanel.gameInit(args)
   ...
   longhudou_PushFun.CreatShowNum(self.myGoldNum,longhudou_Data.myinfoData._7wGold,"win_gold_",false,22,2,310,-142);
   self.choumtxt.gameObject:GetComponent("Text").text = longhudou_Data.baseRate.." × bet:"..longhudou_Data.curSelectChoum;
   longhudou_PushFun.CreatShowNum(self.chouNum,longhudou_Data.curSelectChoum*longhudou_Data.baseRate,"choum_",false,18,2,210,-566);
   --longhudou_PushFun.CreatShowNum(self.allPushNum,longhudou_Data.curSelectChoum*longhudou_CMD.D_LINE_COUNT,"choum_",false,18,2,230,-384);
end
...
--        self.setVisibleBtn(2); 
      ...
      if longhudou_LianLine.IsStartGame==true then
