...
public class DragonBones_UnityArmatureComponentWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegVar("armatureBaseName", get_armatureBaseName, set_armatureBaseName);
		...
		L.RegVar("dbAnimation", get_dbAnimation, null);
	...
	static int DORewind(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: DragonBones.UnityArmatureComponent.DORewind");
			}
		}
		catch (Exception e)
		{
	...
	static int DORestart(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: DragonBones.UnityArmatureComponent.DORestart");
			}
		}
		catch (Exception e)
		{
	...
	static int DOGoto(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: DragonBones.UnityArmatureComponent.DOGoto");
			}
		}
		catch (Exception e)
		{
	...
	static int DOKill(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: DragonBones.UnityArmatureComponent.DOKill");
			}
		}
		catch (Exception e)
		{
	...
	static int DOComplete(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: DragonBones.UnityArmatureComponent.DOComplete");
			}
		}
		catch (Exception e)
		{
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_armatureBaseName(IntPtr L)
	{
		object o = null;
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			DragonBones.UnityArmatureComponent obj = (DragonBones.UnityArmatureComponent)o;
			string ret = obj.armatureBaseName;
			LuaDLL.lua_pushstring(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index armatureBaseName on a nil value");
		}
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int get_dbAnimation(IntPtr L)
	{
		object o = null;
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			DragonBones.UnityArmatureComponent obj = (DragonBones.UnityArmatureComponent)o;
			DragonBones.Animation ret = obj.dbAnimation;
			ToLua.PushObject(L, ret);
			return 1;
		}
		catch(Exception e)
		{
			return LuaDLL.toluaL_exception(L, e, o, "attempt to index dbAnimation on a nil value");
		}
	}
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int set_armatureBaseName(IntPtr L)
	{
		object o = null;
