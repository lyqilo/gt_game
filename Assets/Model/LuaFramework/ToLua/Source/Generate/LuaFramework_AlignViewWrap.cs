...
public class LuaFramework_AlignViewWrap
{
	public static void Register(LuaState L)
	{
		L.BeginClass(typeof(LuaFramework.AlignView), typeof(LuaFramework.BaseBehaviour));
	...
	static int arrangePos(IntPtr L)
	{
		try
		{
			...
			LuaFramework.AlignView obj = (LuaFramework.AlignView)ToLua.CheckObject<LuaFramework.AlignView>(L, 1);
			obj.arrangePos();
			return 0;
		}
		catch (Exception e)
	...
	static int setScreenArgs(IntPtr L)
	{
		try
		{
			...
			LuaFramework.AlignView.setScreenArgs(arg0, arg1, arg2, arg3, arg4);
			return 0;
		}
		catch (Exception e)
		{
	...
	static int get_align(IntPtr L)
	{
		...
		try
		{
			...
			LuaFramework.AlignView obj = (LuaFramework.AlignView)o;
			LuaFramework.Align ret = obj.align;
			ToLua.Push(L, ret);
			return 1;
		}
		catch(Exception e)
	...
	static int set_align(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			LuaFramework.AlignView obj = (LuaFramework.AlignView)o;
			LuaFramework.Align arg0 = (LuaFramework.Align)ToLua.CheckObject(L, 2, typeof(LuaFramework.Align));
			obj.align = arg0;
			return 0;
		}
		catch(Exception e)
