...
public static class LuaBinder
{
	public static void Bind(LuaState L)
	{
		...
		TweenTypeWrap.Register(L);
		TweenDataWrap.Register(L);
		TweenerManagerWrap.Register(L);
		HttpRequestWrap.Register(L);
		HttpResponseWrap.Register(L);
		ImageAnimaWrap.Register(L);
		UnityWebRequestManagerWrap.Register(L);
		FormDataWrap.Register(L);
		...
		UnityEngine_CachingWrap.Register(L);
		...
		LuaFramework_MusicManagerWrap.Register(L);
		...
		LuaFramework_SessionWrap.Register(L);
		LuaFramework_IMGResolutionWrap.Register(L);
		LuaFramework_MD5HelperWrap.Register(L);
		LuaFramework_EventTriggerListenerWrap.Register(L);
		LuaFramework_CsJoinLuaWrap.Register(L);
		LuaFramework_AlignViewWrap.Register(L);
		LuaFramework_AlignViewExWrap.Register(L);
		LuaFramework_ABPacketWrap.Register(L);
		LuaFramework_ValueConfigerWrap.Register(L);
		LuaFramework_PathHelpWrap.Register(L);
		LuaFramework_UnityWebDownPacketQueueWrap.Register(L);
		LuaFramework_BaseValueConfigerJsonWrap.Register(L);
		LuaFramework_UnityWebPacketWrap.Register(L);
		LuaFramework_UnityWebRequestAsyncWrap.Register(L);
		LuaFramework_ConfigHelpWrap.Register(L);
		LuaFramework_NetworkHelperWrap.Register(L);
		LuaFramework_CreateFontWrap.Register(L);
		LuaFramework_UnityWebRequestHelperWrap.Register(L);
		LuaFramework_ILRuntimeManagerWrap.Register(L);
		LuaFramework_BaseBehaviourWrap.Register(L);
		L.EndModule();
		L.BeginModule("Spine");
		...
		DragonBones_UnityDragonBonesDataWrap.Register(L);
		DragonBones_SortingModeWrap.Register(L);
		...
		DragonBones_BlendModeWrap.Register(L);
