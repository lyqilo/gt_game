...
public class LuaFramework_ByteBufferWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("ReadUInt32s", ReadUInt32s);
		L.RegFunction("ReadInts", ReadInts);
		L.RegFunction("ReadInt32s", ReadInt32s);
		L.RegFunction("ReadInt64s", ReadInt64s);
		...
		L.RegFunction("ReadInt64Str", ReadInt64Str);
	...
	static int WriteBytes(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: LuaFramework.ByteBuffer.WriteBytes");
			}
		}
		catch (Exception e)
		{
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int ReadUInt32s(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 2);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int ReadInt32s(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 2);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int ReadInt64s(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 2);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int ReadInt64Str(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 1);
			LuaFramework.ByteBuffer obj = (LuaFramework.ByteBuffer)ToLua.CheckObject<LuaFramework.ByteBuffer>(L, 1);
			string o = obj.ReadInt64Str();
	...
	static int ReadString(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: LuaFramework.ByteBuffer.ReadString");
			}
		}
		catch (Exception e)
		{
