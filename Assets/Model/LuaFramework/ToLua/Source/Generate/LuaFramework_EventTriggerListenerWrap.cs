...
public class LuaFramework_EventTriggerListenerWrap
{
	...
	static int CallFunc(IntPtr L)
	{
		try
		{
			...
			LuaFramework.EventTriggerListener obj = (LuaFramework.EventTriggerListener)ToLua.CheckObject<LuaFramework.EventTriggerListener>(L, 1);
	...
	static int get_onClick(IntPtr L)
	{
		...
		try
		{
			...
			LuaFramework.EventTriggerListener obj = (LuaFramework.EventTriggerListener)o;
			object ret = obj.onClick;
			ToLua.Push(L, ret);
			return 1;
		}
		catch(Exception e)
	...
	static int get_onInitializePotentialDrag(IntPtr L)
	{
		...
		try
		{
			o = ToLua.ToObject(L, 1);
			LuaFramework.EventTriggerListener obj = (LuaFramework.EventTriggerListener)o;
			object ret = obj.onInitializePotentialDrag;
			ToLua.Push(L, ret);
			return 1;
		}
		catch(Exception e)
