...
public class TMPro_TextMeshProUGUIWrap
{
	...
	static int DORewind(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: TMPro.TextMeshProUGUI.DORewind");
			}
		}
		catch (Exception e)
		{
	...
	static int DORestart(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: TMPro.TextMeshProUGUI.DORestart");
			}
		}
		catch (Exception e)
		{
	...
	static int DOGoto(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: TMPro.TextMeshProUGUI.DOGoto");
			}
		}
		catch (Exception e)
		{
	...
	static int DOKill(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: TMPro.TextMeshProUGUI.DOKill");
			}
		}
		catch (Exception e)
		{
	...
	static int DOComplete(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: TMPro.TextMeshProUGUI.DOComplete");
			}
		}
		catch (Exception e)
		{
