...
public class UnityEngine_UI_ScrollRectWrap
{
	...
	static int DORewind(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: UnityEngine.UI.ScrollRect.DORewind");
			}
		}
		catch (Exception e)
		{
	...
	static int DORestart(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: UnityEngine.UI.ScrollRect.DORestart");
			}
		}
		catch (Exception e)
		{
	...
	static int DOGoto(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: UnityEngine.UI.ScrollRect.DOGoto");
			}
		}
		catch (Exception e)
		{
	...
	static int DOKill(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: UnityEngine.UI.ScrollRect.DOKill");
			}
		}
		catch (Exception e)
		{
	...
	static int DOComplete(IntPtr L)
	{
		try
		{
			...
			{
				return LuaDLL.luaL_throw(L, "invalid arguments to method: UnityEngine.UI.ScrollRect.DOComplete");
			}
		}
		catch (Exception e)
		{
