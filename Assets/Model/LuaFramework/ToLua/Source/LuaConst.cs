...
{
    public static string luaDir = $"{Application.dataPath}/ThirdParty/LuaFramework/Lua";                //lua逻辑代码目录
    public static string toluaDir = $"{Application.dataPath}/ThirdParty/LuaFramework/ToLua/Lua";        //tolua lua文件目录
