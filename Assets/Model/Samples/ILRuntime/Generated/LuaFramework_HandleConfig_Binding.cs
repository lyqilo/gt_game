...
{
    unsafe class LuaFramework_HandleConfig_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(LuaFramework.HandleConfig);
        ...
        static StackObject* Write_0(ILIntepreter __intp, StackObject* __esp, AutoList __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = LuaFramework.HandleConfig.Write(@key, @val);
