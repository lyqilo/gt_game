...
namespace Hotfix.Hall.Recharge
{
    public partial class FristRechargeBankPanel
    {
        ...
        public class ChannelItem : FancyScrollRectCell<ChannelData, ChannelContext>
        {
            private Toggle tog;
            private ChannelData Data { get; set; }
            ...
            public override void UpdateContent(ChannelData itemData)
            {
                Data = itemData;
