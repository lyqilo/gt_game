...
namespace Hotfix.CMLHJ
{
    public class CMLHJ_DataConfig
    {
        ...
        /// 连线数量
        /// </summary>
        public const int ALLLINECOUNT = 9;
        ...
        public const float maryRollTime = 1.5f;//转动时间
    ...
    public class Data
    {
        public CMLHJ_Struct.SC_SceneInfo SceneData { get; set; }
        public CMLHJ_Struct.CMD_3D_SC_Result ResultData { get; set; }
        public CMLHJ_Struct.CMD_3D_SC_MaryResult MaryData { get; set; }
        ...
        public bool isMaryGame { get; set; }
        public int CurrentMaryCount { get; set; }
    }
}
