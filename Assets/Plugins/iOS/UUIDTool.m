...
NSString *kUUIDKey = @"com.slyx.hqyx";
...
+ (NSString *)getUUIDInKeychain:(NSString *)_kUUIDKey {
    kUUIDKey=_kUUIDKey;
...
const char *_getUUIDInKeychain(const char *uikey)
{
    NSString *key = [[NSString alloc] initWithUTF8String:uikey];
    NSString *s = [UUIDTool getUUIDInKeychain:key];
